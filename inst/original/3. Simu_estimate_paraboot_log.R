...
# dataall <- readRDS(paste0('SIM_sim_data_', trt_group, '_orig_200_fixcoef'))

setwd("/uufs/chpc.utah.edu/common/home/u6049227/General_sensitivity/ARC_simu_result/parametric_sim_data")
dataall <- readRDS(paste0('SIM_sim_data_', trt_group, '_orig_200_neg'))


B <- 200 # number of parametric bootstrap
...
for(i in range){
  ...
  # end <- Sys.time()
  # end - start
  # Time difference of 22.58844 secs
  ...
  # Time difference of 46.44401 secs
  
  # setwd(paste0('/uufs/chpc.utah.edu/common/home/u6049227/General_sensitivity/ARC_simu_result/single_simu_log_norm1/simu_',
  #              trt_group,
  #              '/para_boot_',
  #              weight_type))
  # 
  # saveRDS(result_trt, file = paste0('sim_paraboot_', save_group, '_log_200_', i))
  
  
  setwd(paste0('/uufs/chpc.utah.edu/common/home/u6049227/General_sensitivity/ARC_simu_result/neg_simu_log_norm1/simu_',
               trt_group,
               '/para_boot_',
               weight_type))
...
# setwd(paste0('/uufs/chpc.utah.edu/common/home/u6049227/General_sensitivity/ARC_simu_result/single_simu_log_fixcoef/simu_',
#              trt_group,
#              '/para_boot_',
#              weight_type))
...
miss_index <- c()
for(i in 1:500){
  temp <- try({readRDS(file = paste0('sim_paraboot_', save_group, '_log_200_', i))}, silent = TRUE)
  if(length(temp) == 1){
