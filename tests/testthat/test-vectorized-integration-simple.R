...
test_that("vectorized integration matches original for alpha = 0", {
    ...
    expect_true(
        ...
        info = sprintf(
            "Max absolute difference: %.6e, Max relative error: %.6e. Note: Large differences may indicate implementation differences between quadv and adaptive Simpson integration.",
