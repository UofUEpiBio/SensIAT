...
W_1(t;\boldsymbol{\beta}) &= \frac{\boldsymbol{V}_1^{-1}\boldsymbol{B}(t)}{\boldsymbol{B}(t)^\prime \boldsymbol{\beta} \left(1-\boldsymbol{B}(t)^\prime \boldsymbol{\beta}\right)}.
\end{align}
$$
...
\boldsymbol{V}_2(\boldsymbol{\beta})^{-1} \boldsymbol{B}(t) 
\frac{ \exp\left(\boldsymbol{B}(t)^\prime \boldsymbol{\beta}\right)}
